...
This repository showcases a simple simulation of a cargo port system developed to understand and master the fundamentals of software engineering, focusing on Object-Oriented Programming (OOP), code maintainability, and testing in Java.
...
* Advanced OOP & File I/O: Applied language features such as inheritance for statistics evaluators and interfaces for encoding and decoding system states to machine-readable strings.
* Time Simulation: Extended the core model to process queued movements and simulate time using a Tickable interface where one tick represents a minute in real life.
